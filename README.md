# The "Eight" Game Solver with BFS / DFS 
This program solves the "eight" game, also known as the sliding puzzle, using the Breadth-First Search (BFS) and Depth-first search (DFS) algorithms.s
